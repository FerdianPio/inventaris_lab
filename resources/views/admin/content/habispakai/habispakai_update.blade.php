...
<div class="row">
    <div class="col-12">
        ...
        @endif
        <form action="{{url('habispakai/update/'.$id)}}" method="post" style="padding-top: 10px">
            @csrf
            <div class="form-group">
                <label for="kodeBarang" class="form-label">Kode</label>
                <input type="text" name="kodeBarang" id="kodeBarang" value="{{$id}}" class="form-control" disabled>
            </div>
            <div class="form-group">
